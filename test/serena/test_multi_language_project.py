...
"""
        ...
        all_refs_result = find_ref_tool.apply(name_path="BaseProcessor", relative_path="base_class.py")
        ...
        py_refs_result = find_ref_tool.apply(name_path="BaseProcessor", relative_path="base_class.py", language="python")
        ...
        ts_refs_result = find_ref_tool.apply(name_path="BaseProcessor", relative_path="base_class.py", language="typescript")
...
def test_project_config_backward_compatibility():
    ...
    old_config = {"project_name": "test_project", "root_path": "/path/to/project", "language": "python"}
    ...
    new_config = {"project_name": "test_project", "root_path": "/path/to/project", "languages": ["python", "typescript"]}
...
def test_empty_project_handling():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        config_dict = {"project_name": "empty_project", "languages": ["python"]}  # Need at least one language
