...
class TestMarkdownLanguageServerBasics:
    ...
    def test_markdown_request_document_symbols(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("README.md", include_body=False).get_all_symbols_and_roots()
    ...
    def test_markdown_request_symbols_from_guide(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("guide.md", include_body=False).get_all_symbols_and_roots()
    ...
    def test_markdown_request_symbols_from_api(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("api.md", include_body=False).get_all_symbols_and_roots()
    ...
    def test_markdown_request_document_symbols_with_body(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("README.md", include_body=True).get_all_symbols_and_roots()
