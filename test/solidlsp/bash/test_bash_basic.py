...
class TestBashLanguageServerBasics:
    ...
    def test_bash_request_document_symbols(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("main.sh", include_body=False).get_all_symbols_and_roots()
    ...
    def test_bash_request_document_symbols_with_body(self, language_server: SolidLanguageServer) -> None:
        ...
        all_symbols, _root_symbols = language_server.request_document_symbols("main.sh", include_body=True).get_all_symbols_and_roots()
    ...
    def test_bash_utils_functions(self, language_server: SolidLanguageServer) -> None:
        ...
        utils_all_symbols, _utils_root_symbols = language_server.request_document_symbols(
    ...
    def test_bash_function_syntax_patterns(self, language_server: SolidLanguageServer) -> None:
        ...
        main_all_symbols, _main_root_symbols = language_server.request_document_symbols(
            "main.sh", include_body=False
        ).get_all_symbols_and_roots()
